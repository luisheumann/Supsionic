...
<div class="busqueda">
  ...
  <form class="form-horizontal form_home_buscar" id="busqueda" action="/api/buscar_cadena2"  method="get">
...
$('#perfil').change(function(event) {
  ...
  if(valueSelected==1)
  {
    ...
    var pach = "/api/buscar_cadena2?perfil=1&categoria=&producto=&country=&origen=&destino=&selectProducto=";
...
if(valueSelected==2)
{
  ...
  var pach = "/api/buscar_cadena2?perfil=2&categoria=&producto=&country=&origen=&destino=&selectProducto=";
  window.location =  pach;
           ...
           if(valueSelected==3)
           {
            ...
            var pach = "/api/buscar_cadena2?perfil=3&categoria=&producto=&country=&origen=&destino=&selectProducto=";
            window.location =  pach;
...
if(valueSelected==4)
{
  ...
  var pach = "/api/buscar_cadena2?perfil=4&categoria=&producto=&country=&origen=&destino=&selectProducto=";
  window.location =  pach;
