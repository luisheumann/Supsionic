  ...
  <div class="">
    <form class="form-horizontal">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          <input type="checkbox"><label class="ancho-checkbox" for="check1">Aéreo</label>
          <input type="checkbox"><label class="ancho-checkbox" for="check1">Terrestre</label>
          <input type="checkbox"><label class="ancho-checkbox" for="check1">Marítimo</label>
          <br>
          <input type="checkbox"><label class="ancho-checkbox" for="check1">Fluvial</label>
          <input type="checkbox"><label class="ancho-checkbox" for="check1">Multimodal</label>            
        </div>
      </div><hr>
      <div class="form-group row">
        <label class="col-md-6 control-label" for="nombre_producto"><strong>Servicios Adicionales</strong></label>
        <div class="col-md-6">
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Operadores Logísticos</label>
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Almacenamiento</label>
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Servicios de Intermediación Aduanera</label>
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Asesoría y consulta Comercio Exterior</label>            
        </div>
      </div><hr>
      <div class="form-group row">
        <label class="col-md-6 control-label" for="nombre_producto"><strong>Especialidades</strong></label>
        <div class="col-md-6">
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Aislamiento de mercancías peligrosas</label>
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Transporte Aéreo de cargo</label>
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Transporte Terreste de Carga</label>
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Transporte Marítimo Consolidado</label>
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Servicio de Transporte Aéreo Internacional</label>          
          <br>
          <input type="checkbox"><label class="ancho-largo-checkbox" for="check1">Servicio de Transporte Aéreo Nacional</label> 
        </div>
      </div><hr>
