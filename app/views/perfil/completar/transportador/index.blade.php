...
<a data-toggle="modal" data-target="#myModal" href="#"  class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-trash"></span></a> 
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
             ...
             <a href="/{{$empresa->slug}}/interes_transportador/delete/{{$interes->id}}">  <input type="submit"  class="btn btn-info btn-md" value="Aceptar"></a>
