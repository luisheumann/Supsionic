   ...
   <hr>  
    ...
    <div class="col-md-12">
      <div class="form-group">
        <label for="productos">
          Detalle adicional de producto<br>
            <strong>
              <em><span id="view_cate"></span></em>
            </strong>
        </label>
        <textarea name="productos" class="form-control" id="productos" rows="4" placeholder=""></textarea>
      </div>
    </div>  
  ...
  <div class="row">  
    <div class="col-md-12">
      <div class="form-group">
        ...
        <input title="Valor 0 es ilimitado por defecto" placeholder="0" type="text" class="form-control" id="min" name="min" value=""> 
		</div>

      <div class="col-md-4">
        <b> Cantidad Maxima</b><br>
          <input title="Valor 0 es ilimitado por defecto" placeholder="0" type="text" class="form-control" id="max" name="max" value="">
         </div>
<div class="col-md-4">
 <b> Unidad</b><br>
