...
<div class="col-md-6">
 ...
 <div class="col-md-12">
          ...
          <div class="row list-imagenes">
           @foreach($imagenes as $imagen)

           <div class="contenedor-img">
<img id="preview-img"  class="teco" height="40" width="40"  src="/uploads/productos/{{$imagen->imagen}}" />
<center>
 <a href="/{{$empresa->slug}}/producto/deleteOne/{{$imagen->id}}/{{$producto->id}}" id="preview-img-a" class="teco" data-full="/uploads/productos/{{$imagen->imagen}}"><button type="button" class="btn btn-primary">Borrar</button></a></center>
</div>
 ...
 <div class="col-md-12">
          <div class="form-group">
            <label class=" control-label"  for="nombre_producto">Referencia</label>
              <input type="text" class="form-control" name="referencia" id="referencia"  value="{{$producto->referencia}}" placeholder="">
            </div>
          </div>
  ...
  <div class="col-md-12">
          <div class="form-group">
            <label class="control-label"  for="nombre_producto">Marca</label>
              ...
              <input type="text" class="form-control" name="marca" id="marca" placeholder=""  value="{{$producto->marca}}">
            </div>
          </div>
...
<div class="col-md-12">
          <div class="form-group">
            <label class=" control-label"  for="nombre_producto">Material</label>
              ...
              <input type="text" class="form-control" name="material" id="material" placeholder="" value="{{$producto->material}}">
            </div>
          </div>
 ...
 <div class="col-md-12">
          <div class="form-group">
            <label class=" control-label"  for="nombre_producto">Color</label>
              <input type="text" class="form-control" name="color" id="color" placeholder="" value="{{$producto->color}}">
            </div>
          </div>
    ...
    <div class="col-md-12">
          <div class="form-group">
            <label class="control-label"  for="nombre_producto">Partida Arancelaria</label>
              ...
              <input type="text" class="form-control" name="partida" id="partida" value="{{$producto->partida}}" placeholder="">
            </div>
          </div>
<!--
          <div class="form-group">
